...
class Ui_Dialog(object):
    ...
    #     self.mask_img = data2
    #     self.mask_img.mousePressEvent = self.on_mousePressEvent

    # def on_mousePressEvent(self, event: QMouseEvent):
    #     data_mask = nib.load(Path(self.mask_path))
    #     self.data = data_mask.get_fdata()  # 获取图像数据
    #     # 获取当前坐标
    #     pos = event.pos()
    #     x, y = pos.x(), pos.y()
    #     print(f"pos: {pos}")
    #     mask_value = self.data[y, x, 1]
    #     print(mask_value)
    #     #test
    ...
    def setupUi(self, Dialog):
        ...
        #self.groupBox.setStyleSheet("QGroupBox::title#groupBox { subcontrol-origin: margin; subcontrol-position: top center; }")
    ...
    # def draw(self):
    #     if global_a==True and global_b==True:
    #         data_mask = nib.load(Path(self.mask_path))
    #         self.data2 = data_mask.get_fdata()
    #     self.data2.mousePressEvent = self.on_mousePressEvent
    #
    # def on_mousePressEvent(self, event: QMouseEvent):
    #     # 获取当前坐标
    #     pos = event.pos()
    #     x, y = pos.x(), pos.y()
    #     print(f"pos: {pos}")
    #     mask_value = self.mask_img[y, x, self.slice_idx - 1]
    #     print(mask_value)
    ...
    def bindButton(self):
        ...
        if self.nii_path == '':
            ...
            #用户按下上传图像按钮并上传正确格式图像，图像就会被程序处理 TODO：需要程序处理则将下面这行注释取消
            #MSCAM(self.nii_path)
    ...
    def on_mousePressEvent(self, event: QMouseEvent):
        ...
        if self.mask_path != '':
            #print(f"Relative point: x={x-60},y={y-60}")
            data_mask = nib.load(Path(self.mask_path))
            data2 = data_mask.get_fdata()
            # 计算相对坐标
    ...
    # def convey_nii_path(self):
    #     return self.nii_path
    # def convey_mask_path(self):
